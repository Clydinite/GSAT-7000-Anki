...
- PART_OF_SPEECH_MISMATCH: The part of speech in the sentence does not match the part of speech in the pattern. Or that the part of speech is accidently marked as the part of speech of the entire pattern.
...
- SENSE_UNDERSPLITTING: A sense should be split.
- SENSE_OVERSPLITTING: Some senses should be merged.
